...
void* local_search3_P(void* solution){
	...
	do{
		...
		sem_wait(&semaphore);
		s_line = acess_sharedMemory(s_line,thread_id, executed_t, PCR_BS_F, 1);
		sem_post(&semaphore);
		...
		writeFileInfos(solution_thread->log_file, executed_t , thread_id, s->f_cost, s->f_cost, s->size_j, PCR_BS_F, 1);
	}while(flag_r);

	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &pcr_best_improvement_foward, thread_id, PCR_BS_F, solution_thread->log_file, 0);
...
void* local_search4_P(void* solution){
	...
	do{
		...
		//compare local search s with shared memory s.
		sem_wait(&semaphore);
		s_line = acess_sharedMemory(s_line,thread_id, executed_t, PCR_BS_B, 1);
		sem_post(&semaphore);
		...
		//update log file of thread.	
		writeFileInfos(solution_thread->log_file, executed_t , thread_id, s->f_cost, s->f_cost, s->size_j, PCR_BS_B, 1);
	}while(flag_r);

	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &pcr_best_improvement_backward, thread_id, PCR_BS_B, solution_thread->log_file, 0);
...
void* local_search15_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_foward, thread_id, n, solution_thread->log_file, 1);
...
void* local_search16_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_backward, thread_id, n, solution_thread->log_file, 1);
...
void* local_search17_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_foward, thread_id, n, solution_thread->log_file, 2);
...
void* local_search18_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_backward, thread_id, n, solution_thread->log_file, 2);
...
void* local_search19_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_foward, thread_id, n, solution_thread->log_file, 3);
...
void* local_search20_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_backward, thread_id, n, solution_thread->log_file, 3);
...
void* local_search21_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_foward, thread_id, n, solution_thread->log_file, 4);
...
void* local_search22_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_backward, thread_id, n, solution_thread->log_file, 4);
...
void* local_search23_P(void* solution){
	...
	do{
		flag_r = 0;
		clock_t time_s = clock();
		Solution* s_line = kswap_best_improvement_foward(copySolution(s), 5);
		clock_t time_f = clock();
		double executed_t = (double)(time_f - time_s) / CLOCKS_PER_SEC;
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_foward, thread_id, n, solution_thread->log_file, 5);
...
void* local_search24_P(void* solution){
	...
	////////////////// SECOND WHILE
	//s = second_local_search(s, solution_thread->k, &kswap_best_improvement_backward, thread_id, n, solution_thread->log_file, 5);
